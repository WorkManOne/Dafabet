            ...
            ScrollView {
                VStack (alignment: .leading, spacing: 15) {
                    ...
                    Text("Equipment Name")
                        .font(.system(size: 14, weight: .regular))
                        .foregroundStyle(.white)
                    TextField("", text: $equipment.name, prompt: Text("e.g., MRF Genius").foregroundStyle(.lightGray))
                        .foregroundStyle(.white)
                    ...
                    Text("Brand")
                        .font(.system(size: 14, weight: .regular))
                        .foregroundStyle(.white)
                    TextField("", text: $equipment.brand, prompt: Text("e.g., MRF").foregroundStyle(.lightGray))
                        .foregroundStyle(.white)
                        .font(.system(size: 16, weight: .regular))
                        .darkFramed(isBordered: true)
                    HStack (spacing: 15) {
                        VStack (alignment: .leading) {
                            Text("Size")
                                .font(.system(size: 14, weight: .regular))
                                .foregroundStyle(.white)
                            TextField("", text: $equipment.size, prompt: Text("Enter size").foregroundStyle(.lightGray))
                                .foregroundStyle(.white)
                                .font(.system(size: 16, weight: .regular))
                                .darkFramed(isBordered: true)
                        }
                        VStack (alignment: .leading) {
                            Text("Weight")
                                .font(.system(size: 14, weight: .regular))
                                .foregroundStyle(.white)
                            TextField("", text: $equipment.weight, prompt: Text("Enter count").foregroundStyle(.lightGray))
                                .foregroundStyle(.white)
                                .font(.system(size: 16, weight: .regular))
                                .darkFramed(isBordered: true)
                        }
                    ...
                    HStack (spacing: 15) {
                        ...
                        VStack (alignment: .leading) {
                            Text("Price, ₹")
                                .font(.system(size: 12, weight: .regular))
                                .foregroundStyle(.lightGray)
                            TextField("", text: $equipment.price, prompt: Text("Enter count").foregroundStyle(.lightGray))
                                .foregroundStyle(.white)
                                .darkFramed(isBordered: true)
                        }
                    }
